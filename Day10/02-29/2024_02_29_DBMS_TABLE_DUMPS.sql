...
CREATE TABLE `animal_ins` (
  ...
  `intake_condition` varchar(100) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `sex_upon_intake` varchar(100) DEFAULT NULL
...
INSERT INTO `animal_ins` VALUES ('A352713','Cat','2017-04-13 16:29:00','Normal','Gia','Spayed Female'),('A350375','Cat','2017-03-06 15:01:00','Normal','Meo','Neutered Male');
...
CREATE TABLE `animal_outs` (
  ...
  `datetime` datetime DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `sex_upon_outcome` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `animal_outs` VALUES ('A349733','Dog','2017-09-27 19:09:00','Allie','Spayed Female'),('A352713','Cat','2017-04-25 12:25:00','Gia','Spayed Female'),('A349990','Cat','2018-02-02 14:18:00','Spice','Spayed Female');
...
INSERT INTO `author` VALUES (1,'홍길동'),(2,'김영호');
...
INSERT INTO `book` VALUES (1,'인문',1,10000,'2020-01-01'),(2,'경제',1,9000,'2021-04-11'),(3,'경제',2,11000,'2021-02-05');
...
INSERT INTO `car_rental_company_car` VALUES (1,'세단',16000,'가죽시트,열선시트,후방카메라'),(2,'SUV',14000,'스마트키,네비게이션,열선시트'),(3,'SUV',22000,'주차감지센서,후방카메라'),(4,'트럭',35000,'주차감지센서,네비게이션,열선시트'),(5,'SUV',16000,'가죽시트,네비게이션,열선시트,후방카메라,주차감지센서');
/*!40000 ALTER TABLE `car_rental_company_car` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cop_employee`
--

DROP TABLE IF EXISTS `cop_employee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cop_employee` (
  ...
  KEY `cop_employee_name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cop_employee`
--

LOCK TABLES `cop_employee` WRITE;
/*!40000 ALTER TABLE `cop_employee` DISABLE KEYS */;
INSERT INTO `cop_employee` VALUES (1,'허대표',20000000,'사장'),(2,'정부장',6000000,'부장'),(3,'박차장',5000000,'차장'),(4,'장과장',4000000,'과장'),(5,'정대리',3000000,'대리'),(6,'노사원',2500000,'사원'),(7,'하사원',2400000,'사원'),(8,'정인턴',1100000,'인턴');
/*!40000 ALTER TABLE `cop_employee` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cust` VALUES (1,'Alice','alice@example.com','123-4567'),(2,'Bob','bob@example.com','234-5678'),(3,'Charlie','charlie@example.com','345-6789'),(4,'David','david@example.com','456-7890');
...
INSERT INTO `department` VALUES (10,'활동부',NULL,NULL),(20,'인사팀',NULL,NULL),(100,'상품관리부',10,NULL),(101,'영업부',100,'Information Bldg'),(102,'개발부',100,'Multimedia Bldg'),(103,'총무부',100,'Software Bldg'),(200,'고객관리부',10,NULL),(201,'경리부',200,'Electronic Control Bldg'),(202,'생산1팀',200,'Machining Experiment Bldg'),(203,'생산2팀',200,'Chemical Experiment Bldg'),(300,'품질관리부',20,NULL),(301,'기술지원팀',300,'College of Liberal Arts');
...
INSERT INTO `emp` VALUES (19900101,'홍길동','1964-01-25','0001','Permanent employee','054)223-0001','music',100000000,'Boss',NULL),(19930331,'윤준형','1976-05-25','1001','Perment employee','02)6255-8010','bike',60000000,'Deputy department head',19960101),(19930402,'감자바','1972-08-15','1004','Perment employee','042)998-7005','Climb',51000000,'Section head',19966102),(19950303,'김준형','1973-06-15','1002','Perment employee','02)6255-8020','Marathon',56000000,'Section head',19960101),(19960101,'홍길순','1973-03-22','1000','Permanent employee','02)6255-8000','reading',72000000,'Department head',19900101),(19960212,'주먹밥','1972-12-15','1007','Perment employee','054)223-4600',NULL,49000000,'Section head',19970112),(19960303,'김자바','1971-09-25','1005','Perment employee','031)564-3340','Climb',35000000,'Deputy Section chief',19966102),(19966102,'고길동','1972-07-05','1003','Perment employee','052)223-4000','Music',75000000,'Department head',19900101),(19970112,'고구마','1976-11-05','1006','Perment employee','054)223-4500','Swim',68000000,'Department head',19900101),(19970201,'김길동','1975-04-15','1000','Permanent employee','02)6255-8005','Fitness',50000000,'Section head',19960101),(20000101,'이승혁','1985-01-25','1008','Contracted Worker','051)123-4567','Climb',30000000,'',19960212),(20000102,'고민재','1983-03-22','1009','Contracted Worker','031)234-5678','Fishing',30000000,'',19960212),(20000119,'장국환','1980-11-05','1004','Intern','042)901-2345','Drinking',20000000,'',19930402),(20000203,'고승현','1982-04-15','1010','Contracted Worker','02)2345-6789','Baduk',30000000,'',19960212),(20000210,'나선욱','1980-12-15','1005','Intern','031)345-3456','Reading book',20000000,'',19960303),(20000305,'이승원','1980-06-16','1008','Probation','051)567-8901','Reading book',22000000,'',19960212),(20000308,'장재봉','1980-09-25','1011','Intern','053)890-1234','Golf',20000000,'',19960212),(20000334,'이승재','1981-05-25','1011','Contracted Worker','053)456-7890','Singing',30000000,'',19960212),(20000407,'이준용','1980-08-15','1010','Probation','02)2789-0123','Computer game',22000000,'',19960212),(20006106,'이영길','1980-07-05','1009','Probation','031)678-9012','Driking',22000000,'',19960212);
...
INSERT INTO `emp1` VALUES (10001,'김대표',NULL),(10002,'장과장',10001),(10003,'윤대리',10002),(10004,'이대리',10002),(10005,'박사원',NULL),(10001,'김대표',NULL),(10002,'장과장',10001),(10003,'윤대리',10002),(10004,'이대리',10002),(10005,'박사원',1),(10001,'김대표',NULL),(10002,'장과장',10001),(10003,'윤대리',10002),(10004,'이대리',10002),(10005,'박사원',NULL);
...
INSERT INTO `employee` VALUES (1,'허대표',20000000,'사장'),(2,'정부장',6000000,'부장'),(3,'박차장',5000000,'차장'),(4,'장과장',4000000,'과장'),(5,'정대리',3000000,'대리'),(6,'노사원',2500000,'사원'),(7,'하사원',2400000,'사원'),(8,'정인턴',1100000,'인턴');
...
INSERT INTO `hero` VALUES (1,1,'안중근'),(2,1,'윤봉길'),(3,2,'김유신'),(4,2,'이순신'),(5,3,'이성계'),(6,3,'홍길동'),(7,4,'홍길순');
...
INSERT INTO `orde` VALUES (1,1,'2022-03-01'),(2,1,'2022-03-03'),(3,2,'2022-03-02'),(4,3,'2022-03-01'),(5,3,'2022-03-04'),(6,3,'2022-03-05'),(7,4,'2022-03-01'),(8,4,'2022-03-03'),(9,4,'2022-03-04');
...
INSERT INTO `people` VALUES (1,'임대필',28),(2,'나일규',28),(3,'서진영',23),(4,'김진철',31),(5,'박성준',20),(6,'이진성',22);
...
INSERT INTO `places` VALUES (4431977,'BOUTIQUE STAYS - Somerset Terrace, Pet Friendly',760849),(5194998,'BOUTIQUE STAYS - Elwood Beaches 3, Pet Friendly',760849),(16045624,'Urban Jungle in the Heart of Melbourne',30900122),(17810814,'Stylish Bayside Retreat with a Luscious Garden',760849),(22740286,'FREE PARKING - The Velvet Lux in Melbourne CBD',30900122),(22868779,'★ Fresh Fitzroy Pad with City Views! ★',21058208);
/*!40000 ALTER TABLE `places` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pro_test1`
--

DROP TABLE IF EXISTS `pro_test1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `pro_test1`
--

LOCK TABLES `pro_test1` WRITE;
/*!40000 ALTER TABLE `pro_test1` DISABLE KEYS */;
INSERT INTO `pro_test1` VALUES (1,'테스트1',30),(2,'테스트1',30),(4,'테스트1',30);
/*!40000 ALTER TABLE `pro_test1` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `product` VALUES (1,'니트',10000),(2,'반팔티',5000),(3,'청바지',8000),(4,'코트',20000),(5,'후드티',7500),(6,'와이셔츠',7000);
...
INSERT INTO `product1` VALUES (1,'A1000011',10000),(2,'A1000045',9000),(3,'C3000002',22000),(4,'C3000006',15000),(5,'C3000010',30000),(6,'K1000023',17000);
...
LOCK TABLES `rest_info` WRITE;
/*!40000 ALTER TABLE `rest_info` DISABLE KEYS */;
INSERT INTO `rest_info` VALUES ('00001','은돼지식당','한식',1150345,734,'N','서울특별시 중구 다산로 149','010-4484-8751'),('00002','하이까쯔네','일식',120034,112,'N','서울시 중구 신당동 375-21',NULL),('00003','따띠따띠뜨','양식',1234023,102,'N','서울시 강남구 신사동 627-3 1F','02-6397-1023'),('00004','스시사카우스','일식',1522074,230,'N','서울시 서울시 강남구 신사동 627-27','010-9394-2554'),('00005','코슌스','일식',15301,123,'N','서울특별시 강남구 언주로153길','010-1315-8729');
/*!40000 ALTER TABLE `rest_info` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `stu` VALUES (1,'John',25,'남성'),(2,'Alice',17,'여성'),(3,'Bob',20,'남성'),(4,'Eve',16,'여성'),(5,'Milk',27,'여성'),(6,'Pat',15,'남성');
...
INSERT INTO `tbl1` VALUES (1,'허대표',20000000,'사장'),(2,'정부장',6000000,'부장'),(3,'박차장',5000000,'차장'),(4,'장과장',4000000,'과장'),(5,'정대리',3000000,'대리'),(6,'노사원',2500000,'사원'),(7,'하사원',2400000,'사원'),(8,'정인턴',1000000,'인턴');
/*!40000 ALTER TABLE `tbl1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_cons`
--

DROP TABLE IF EXISTS `tbl_cons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_cons` (
  ...
  CONSTRAINT `tbl_cons_chk_1` CHECK (((`area` >= 1) and (`area` <= 4)))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_cons`
--

LOCK TABLES `tbl_cons` WRITE;
/*!40000 ALTER TABLE `tbl_cons` DISABLE KEYS */;
INSERT INTO `tbl_cons` VALUES (1,'홍길동','9512011234567',1,10001),(2,'홍길동','주민2',1,10001);
/*!40000 ALTER TABLE `tbl_cons` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `test1` VALUES (1,'테스트1',30),(4,'테스트4',24),(5,'테스트5',20),(7,'장독대',30),(8,'전우치',77),(9,'폰셔틀',44),(10,'테스트2',30);
/*!40000 ALTER TABLE `test1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `test1del`
--

DROP TABLE IF EXISTS `test1del`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `test1del`
--

LOCK TABLES `test1del` WRITE;
/*!40000 ALTER TABLE `test1del` DISABLE KEYS */;
INSERT INTO `test1del` VALUES (NULL,NULL,NULL),(NULL,NULL,NULL),(6,'홍길동',24);
/*!40000 ALTER TABLE `test1del` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `university` VALUES (1,'서울대','한국최고대학교'),(2,'고려대','최고대학교'),(3,'연세대','최고대학교'),(4,'중앙대','중간짬'),(5,'치킨대학교','치킨');
...
INSERT INTO `used_goods_board` VALUES ('B0007','s2s2123','커피글라인더','내용1',7000,'2022-10-04','DONE',210),('B0008','hong02','자전거 판매합니다','내용1',40000,'2022-10-04','SALE',301),('B0009','yawoong67','선반 팝니다','내용1',12000,'2022-10-05','DONE',202),('B0010','keel1990','철제선반5단','내용1',10000,'2022-10-05','SALE',194);
...
INSERT INTO `user` VALUES (1,'user1','aaaa','01011111111','남자',5000,'seoul'),(2,'user2','bbbb','01022222222','여자',10000,NULL),(3,'user3','cccc','01033333333','남자',10000,'busan'),(4,'user4','dddd','01044444444','여자',5000,NULL),(5,'user5','eeee','01055555555','남자',5000,'ulsan'),(6,'user6','ffff','01066666666','남자',5500,'incheon'),(7,'user7','gggg','01077777777','여자',7000,'daegu');
...
INSERT INTO `user_info` VALUES (1,1,26,'2021-10-05'),(2,0,NULL,'2021-11-25'),(3,1,22,'2021-11-30'),(4,0,31,'2021-12-03'),(5,0,28,'2021-12-16'),(6,1,24,'2022-01-03'),(7,1,NULL,'2022-01-09');
...
CREATE TABLE `worker` (
  ...
  PRIMARY KEY (`num`),
  CONSTRAINT `worker_chk_1` CHECK ((`gender` in (_utf8mb4'M',_utf8mb4'F')))
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `worker` VALUES (1,'jhjang','장종훈','M',38,'총무부','010-3347-7474','서울시 강동구'),(2,'jek98','안달훈','M',25,'인사부','010-3744-4747','강원도 정선군'),(3,'ims2','이세영','F',48,'경리부','010-3736-4784','전라북도 전주시'),(4,'apple3','김소영','F',52,'총무부','010-2845-8978','전라남도 순천시'),(5,'sub093','김수정','M',53,'홍보부','010-3834-1248','경상북도 상주시'),(6,'chulsu','김철수','M',33,'홍보부','010-1235-3788','경기도 오산시'),(7,'yckim','김영철','M',32,'인사부','010-2222-3333','경기도 용인시'),(8,'yerin99','김예린','F',25,'총무부','010-7777-9999','서울시 강서구'),(9,'sjjung','정수정','F',35,'경리부','010-3636-3563','충청남도 아산시'),(10,'tuttle7','이예린','F',21,'연구소','010-3756-9823','경기도 성남시');
...
-- Dump completed on 2024-02-29 10:26:25
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-02-14 02:00:45',NULL),('diagnostics.include_raw','OFF','2024-02-14 02:00:45',NULL),('ps_thread_trx_info.max_length','65535','2024-02-14 02:00:45',NULL),('statement_performance_analyzer.limit','100','2024-02-14 02:00:45',NULL),('statement_performance_analyzer.view',NULL,'2024-02-14 02:00:45',NULL),('statement_truncate_len','64','2024-02-14 02:00:45',NULL);
...
-- Dump completed on 2024-02-29 10:26:26
